senha = prompt("digite sua senha:ndigite sair para cancelar","");
	...
	document.getElementById('pagina').style.display = 'block';
		...
		alert("campo obrigatorio");window.location = "http://silviors.dlinkddns.com:881" 
		}else if(senha =="sair"){
		alert("cancelado");window.location = "www.terra.com.br"
}else{
alert("senha errada");window.location = "http://silviors.dlinkddns.com:881"
}
...
function AlteraRele14(){
    ...
    if(estado_14 === "0"){
        ...
        document.getElementById("botao_14").innerHTML="<a href='/?14_ligar' class='botao_14'>Liga</a>";
    }
}
...
function AlteraRele15(){
    ...
    if(estado_15 === "0"){
		...
		document.getElementById("botao_15").innerHTML="<a href='/?15_desligar' class='botao_15'>Abrir</a>";
    } else {
        document.getElementById("estado_15").innerHTML="0";
        document.getElementById("rele_15").innerHTML="<div class='rele15_desligado'></div>";
        document.getElementById("botao_15").innerHTML="<a href='/?15_ligar' class='botao_15'>Abrir</a>";
    }
}
...
function AlteraRele16(){
    ...
    if(estado_16 === "0"){
        ...
        document.getElementById("botao_16").innerHTML="<a href='/?16_ligar' class='botao_16'>Liga</a>";
    }
}